...
const Add = () => {
  ...
  return (
    <div style={{backgroundColor:'#FFD7AC'}}>
      <Header />
      <div className="container ">
        <div className="row">
          <div className="col-lg-8 mx-auto mt-4 border p-4 mb-5 shadow rounded">
            <h1><i>Add User</i></h1>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <div>
                  ...
                  <label htmlFor="male" className="form-label me-3" style={{ marginLeft: '10px' }}> Male</label>
              ...
              <button type="submit" className="btn btn-primary d-block mx-auto mt-4 ">Submit</button>
            </form>
          </div>
        </div>
      </div>
